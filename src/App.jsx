            ...
            <div style={{ padding: 20, display: "flex", flexDirection: "column", gap: 0 }}>
              ...
              <div style={{ paddingBottom: 16 }}>
                ...
                <div style={{ fontSize: 13, color: C.textDim, lineHeight: 1.7 }}>
                  Tenés hasta el comienzo de cada partido para cargar tus pronósticos, amigo del campin. Si alguna vez te olvidás, se usa tu <strong style={{ color: C.text }}>resultado por defecto</strong>
                </div>
              </div>
